...
head(RPI_Weather_Week) # head of the data fram, NOTE: it will show only 6 rows, usually head() function shows
# the first 6 rows of the dataframe, here we have only 7 rows in our dataframe.
...
# RPI_Weather_Week[descending_snows,]
